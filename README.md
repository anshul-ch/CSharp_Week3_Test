...
This application simulates a payroll system where different types of employees are processed using inheritance and runtime polymorphism. Salary calculations are performed without conditional checks on employee types, and multiple departments are notified after salary processing using delegates.
